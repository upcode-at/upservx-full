...
### What's New in Upcode Harbor v0.5.2
...
- After pulling, run `npm install` in `upcode-harbor/` and `pip install -r requirements.txt` in `upcode-harbor-service/` to apply updated dependencies.
