...
Secrets are stored encrypted in /etc/upcode-harbor/2fa.json using the existing
...
_2FA_FILE = "/etc/upcode-harbor/2fa.json"

# ---------------------------------------------------------------------------
# Persistent store for pending setup sessions:
#   /etc/upcode-harbor/2fa_setup.json  ->  {token: {username, secret, expires}}
# ---------------------------------------------------------------------------
_SETUP_FILE = "/etc/upcode-harbor/2fa_setup.json"
...
#   /etc/upcode-harbor/login_tokens.json  ->  {token_hash: {username, expires, attempts}}
# ---------------------------------------------------------------------------
_LOGIN_TOKENS_FILE = "/etc/upcode-harbor/login_tokens.json"
