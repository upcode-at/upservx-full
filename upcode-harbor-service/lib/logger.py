...
Writes human-readable activity entries to /var/log/upcode-harbor/activity.log
in the format:
...
ACTIVITY_LOG_FILE = "/var/log/upcode-harbor/activity.log"
...
_logger = logging.getLogger("upcode-harbor.activity")
