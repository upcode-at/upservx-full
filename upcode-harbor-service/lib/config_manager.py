"""
Configuration management for /etc/upcode-harbor settings.
...
CONFIG_DIR = os.getenv("UPCODE_HARBOR_CONFIG_DIR", "/etc/upcode-harbor")
...
SSH_KEYS_DIR = os.getenv("UPCODE_HARBOR_SSH_KEY_DIR", os.path.join(STATE_DIR, "ssh_keys"))

class ConfigManager:
    """Manage /etc/upcode-harbor configuration files."""
