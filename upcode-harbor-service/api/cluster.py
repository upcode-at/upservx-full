...
UPCODE_HARBOR_CONFIG_DIR = os.getenv("UPCODE_HARBOR_CONFIG_DIR", "/etc/upcode-harbor")
MASTER_CONFIG_FILE = os.path.join(UPCODE_HARBOR_CONFIG_DIR, "master")
CHILD_CONFIG_FILE = os.path.join(UPCODE_HARBOR_CONFIG_DIR, "child")
NODES_DIR = os.path.join(UPCODE_HARBOR_CONFIG_DIR, "nodes")
...
def ensure_config_dir():
    ...
    try:
        ensure_config_directory(UPCODE_HARBOR_CONFIG_DIR)
        ensure_config_directory(NODES_DIR)
        _clog(f"[CLUSTER] Config directories ensured: {UPCODE_HARBOR_CONFIG_DIR}, {NODES_DIR}")
...
REPLICATIONS_FILE = os.path.join(UPCODE_HARBOR_CONFIG_DIR, "replications.json")
...
TEMP_EXPORT_DIR = "/tmp/upcode_harbor_exports"
