...
APP_STORE_DIR = os.getenv("UPCODE_HARBOR_APP_STORE_DIR", "/var/lib/upcode-harbor/app-store")
COMPOSE_BASE_DIR = os.getenv("UPCODE_HARBOR_COMPOSE_DIR", "/var/lib/upcode-harbor/compose")
APP_DATA_BASE_DIR = os.getenv(
    "UPCODE_HARBOR_APP_DATA_DIR", "/var/lib/upcode-harbor/app-data"
)
APP_SCHEMA_PATH = os.getenv(
    "UPCODE_HARBOR_APP_SCHEMA", os.path.join(APP_STORE_DIR, "app.schema.json")
)
INSTALL_METADATA = ".upcode-harbor-installation.json"
PROJECT_PATTERN = re.compile(r"^[a-z0-9][a-z0-9_-]{0,62}$")
INSTALL_TIMEOUT = int(os.getenv("UPCODE_HARBOR_APP_INSTALL_TIMEOUT", "900"))
