...
def helper():
    return _load_script("upcode-harbor-privileged")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("nft", ["add", "table", "inet", "upcode_harbor_filter"]),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("systemctl", ["start", "upcode-harbor-update@unsigned.service"]),
        ("nft", ["flush", "ruleset"]),
...
def _prepare_managed_nginx_site(helper, monkeypatch, tmp_path):
    ...
    available = available_dir / "upcode_harbor_example_com"
