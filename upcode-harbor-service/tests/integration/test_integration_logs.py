...
class TestLogsApi:
    def test_activity_log_reads_upcode_harbor_activity_file(self, client, api_key_headers):
        ...
        read_log_file.assert_called_once_with("/var/log/upcode-harbor/activity.log", lines=100)
    ...
    def test_activity_log_accepts_lines_query(self, client, api_key_headers):
        ...
        assert resp.status_code == 200
        read_log_file.assert_called_once_with("/var/log/upcode-harbor/activity.log", lines=25)
