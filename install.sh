...
PACKAGES="python3 python3-pip python3-venv git nodejs npm lshw lxd qemu-kvm libvirt-daemon-system dnsmasq libvirt-clients sshfs vsftpd postgresql ftp zfsutils-linux linux-headers-$(uname -r) dkms"
