...
PACKAGES="python3 python3-pip python3-venv python3-certbot nginx certbot git nodejs npm lshw lxd qemu-kvm libvirt-daemon-system dnsmasq libvirt-clients sshfs vsftpd postgresql openvpn ftp zfsutils-linux linux-headers-$(uname -r) dkms"
