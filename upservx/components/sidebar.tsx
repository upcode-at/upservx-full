...
interface SidebarItem {
  ...
  requires: "admin" | "containers" | "vms" | "storage" | "shell" | null
...
export function Sidebar({ activeSection, onSectionChange }: SidebarProps) {
  ...
  const hasPermission = (requires: "admin" | "containers" | "vms" | "storage" | "shell" | null) => {
    ...
    <div className="w-64 upservx-sidebar flex flex-col">
      <div className="p-6 border-b border-sidebar-border/30">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground/60 font-mono pl-4">v0.2.0</p>
        </div>
      </div>
