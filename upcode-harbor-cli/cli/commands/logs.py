"""
upcode-harbor logs – view Upcode Harbor platform logs.

Commands:
  upcode-harbor logs show [--lines N] [--raw]
  upcode-harbor logs follow [--raw]
"""
...
LOG_FILE = "/var/log/upcode-harbor/activity.log"
