"""
upcode-harbor apps – manage App Store applications.

Commands:
  upcode-harbor apps list
  upcode-harbor apps install <app> [--name project] [--env KEY=VALUE]
  upcode-harbor apps info <app>
  upcode-harbor apps update <project>
"""
