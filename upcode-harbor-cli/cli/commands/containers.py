"""
upcode-harbor containers – manage Docker containers via the Upcode Harbor API.

Commands:
  upcode-harbor containers list
  upcode-harbor containers start <name>
  upcode-harbor containers stop <name>
  upcode-harbor containers restart <name>
  upcode-harbor containers remove <name>
  upcode-harbor containers logs <name> [--lines N]
  upcode-harbor containers inspect <name>
"""
