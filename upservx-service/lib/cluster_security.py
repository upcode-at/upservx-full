...
CLUSTER_SECURITY_DIR = Path(
    os.getenv("UPSERVX_CLUSTER_SECURITY_DIR", "/etc/upservx/cluster-security")
)
...
CONFIG_DIR = Path(os.getenv("UPSERVX_CONFIG_DIR", "/etc/upservx"))
...
MAX_CLOCK_SKEW_SECONDS = int(
    os.getenv("UPSERVX_CLUSTER_MAX_CLOCK_SKEW_SECONDS", "60")
)
