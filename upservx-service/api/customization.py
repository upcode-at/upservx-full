...
Stored in /opt/upservx/customization/
"""
...
async def upload_logo(file: UploadFile = File(...)):
    """Upload a custom logo image. Saved as /opt/upservx/customization/logo.<ext>."""
    _ensure_dir()
...
async def upload_banner(file: UploadFile = File(...)):
    """Upload a custom login banner image. Saved as /opt/upservx/customization/banner.<ext>."""
    _ensure_dir()
